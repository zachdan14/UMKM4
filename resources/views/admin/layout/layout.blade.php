...
<body>  
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="#">GoPhotographer</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <a class="nav-link {{ (request()->segment('1')=='' || request()->segment('1') == 'about') ?
                'active' : '' }}" aria-current="page" href="#">
...
<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            <img src="assets/exp2.jpeg" class="d-block w-100" alt="Slide 2">
            <div class="carousel-caption d-none d-md-block">
                <p>Ini dia fotografer kami, mari jelajahi!</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="assets/exp6.jpeg" class="d-block w-100" alt="Slide 3">
            <div class="carousel-caption d-none d-md-block">
                <p>Ini dia fotografer kami, mari jelajahi!</p>
            </div>
        </div>
...
<div class="container mt-5">
    <div class="row">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="assets/exp1.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="assets/exp4.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="assets/exp5.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
