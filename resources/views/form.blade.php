...
<body style="background-color: #98E4FF;">
       ...
       <input type="hidden" name="idpesanan" value="{{ Str::uuid()->toString() }}">
            <h3>Form Pemesanan</h3>
            <div class="form-group">
                <label for="nama">Nama Lengkap:</label>
                <input type="nama" id="nama_user" name="nama_user" placeholder="Masukkan nama lengkap">
            </div>
            <div class="form-group">
            <label for="gmail">Alamat Email (Gmail):</label>
            <input type="email" id="email" name="email" placeholder="Masukkan alamat email">
             </div>
            <div class="form-group">
            <label for="no-wa">Nomor WhatsApp:</label>
            <input type="tel" id="kontak" name="kontak" placeholder="Masukkan nomor WhatsApp">
            </div>
        ...
        <label for="tipe">Paket:</label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="rincian" id="keterangan" cols="60" rows="5"></textarea>
                </div>
            </div>
            <p id="harga"></p>
       <div>
            <label for="pembayaran">Pilih Metode Pembayaran:</label> <br>
            <input type="radio" id="qris" name="payment" value="qris" onclick="showQrisImage()">
            <label for="qris">QRIS</label><br>
            <input type="radio" id="cod" name="payment" value="cod" onclick="showQrisImage()">
            <label for="cod">COD (Cash on Delivery)</label><br>
       </div>
    <div id="qris-image">
        <img src="/assets/dana.jpg" alt="QRIS Image" />
